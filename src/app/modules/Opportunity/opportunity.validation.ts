...
const opportunityValidationToUpdate = z.object({
  body: z
    .object({
      title: z
        .string({
      ...
      image: z.array(z.string()).optional(), // Optional for updates
      description: z
        .string({
      ...
      organization: z
        ...
        .optional(),
      skillsRequired: z.array(z.string()).min(1).optional(), // Optional, but must contain at least 1 if provided
      startDate: z.string().optional(), // Optional with date format validation
      endDate: z.string().optional(), // Optional with date format validation
      status: z.enum(["OPEN", "CLOSED"]).optional(), // Optional status
    })
    .strict()
    .refine(
      data => {
...
export const opportunityValidationSchema = {
